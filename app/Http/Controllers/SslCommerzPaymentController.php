...
class SslCommerzPaymentController extends Controller
{
    ...
    public function exampleHostedCheckout(Request $request)
    {
        ...
        $this->data['product_unit'] = $request->product_unit;
        $this->data['product_total'] = $request->product_total;
        $this->data['delivery_charge'] = $request->delivery_charge;
        $this->data['order_total'] = $request->order_total;
        $this->data['product_quantity'] = $request->product_quantity;
